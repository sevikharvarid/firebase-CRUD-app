...
//        final int id = intent.getExtras().getInt("question_id");
        ...
        changeReplyButton.setVisibility(View.GONE);
      ...
      /*  ListView answerList= findViewById(R.id.answerList);
        ...
        FirebaseListAdapter<Answer> firebaseListAdapter = new FirebaseListAdapter<Answer>(
            ...
            protected void populateView(View v, final Answer model, int position) {
                ...
                //author.setText("by "+model.());
                //author.setText("by Anonim");
                final DatabaseReference dbRef = database.getReference("answers");
                changeReplyButton.setVisibility(View.GONE);
            ...
            public void onClick(View view) {
                ...
                dbRef.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        int ans = (int)dataSnapshot.child(String.valueOf(id)).getChildrenCount();
                        FirebaseUser currentUser = FirebaseAuth.getInstance().getCurrentUser();

                        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("answers");

                        Answer a = new Answer(num, ans, replyText.getText().toString(), "Admin");
                        ref.child(String.valueOf(id)).child(String.valueOf(num)).push().setValue(a);
...
//        Toast.makeText(this, "ID: "+, Toast.LENGTH_SHORT).show();
    ...
    private void getData(){
        ...
        //final String getPrimaryKey = getIntent().getExtras().getString("dataPrimaryKey");
